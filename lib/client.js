window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function StatusCard({ t, state, refresh, onClose, keyRef, onSelectKey }) {
				...
				children: [
					...
					open ? react_jsx_runtime.jsxs(react.Fragment, {
						children: [
							...
							react_jsx_runtime.jsx(StatusCard, { t, state, refresh, onClose: () => setOpen(false), keyRef, onSelectKey: (ref) => setKeyRef(ref) })
						]
					}) : null
				]
			});
