window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		// ---- theme-aware palette (follows the harness light/dark theme) ----
		...
		const C = {
			...
			shadow: "var(--dsw-shadow-lv1, 0 10px 30px rgba(0,0,0,0.5))",
			font: '"Inter","PingFang SC","Microsoft YaHei",system-ui,-apple-system,BlinkMacSystemFont,sans-serif',
			// solid surfaces so buttons/dropdowns always show an area (light vs dark)
			get mutedBg() { return isLightSurface() ? "#e8eaef" : "#27282e"; },
			get card2() { return isLightSurface() ? "#ffffff" : "#1f2025"; }
		};
