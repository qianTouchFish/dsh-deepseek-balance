window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		// ---- sidebar strip (always visible, above Settings; always shows the 4 metrics) ----
		function StatusStrip({ t, state, period, onClick }) {
			...
			const line = { fontSize: 8, color: C.muted, lineHeight: "10px", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", letterSpacing: "-0.2px" };
			return react_jsx_runtime.jsx("button", {
				...
				children: [
					react_jsx_runtime.jsx("span", { style: { fontSize: 9, fontWeight: 700, color, lineHeight: "11px", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: `${t("balance")} ${fmtMoney(total)}` }),
